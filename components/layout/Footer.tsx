  ...
  return (
    <>
      ...
      >
                ...
                >
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full px-12 py-3.5 rounded-xl bg-white/80 backdrop-blur-sm border border-white text-gray-900 placeholder-gray-600 focus:outline-none focus:border-white focus:ring-2 focus:ring-white/50 transition-all"
                      required
                    />
                  </div>
                  <button
                    type="submit"
                    className="px-8 py-3.5 bg-gray-900 text-white rounded-xl font-semibold hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 group border border-white"
                  >
                    <span>Subscribe</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
            ...
            <div>
              ...
              <ul className="space-y-3.5">
                <li>
                  <Link
                    href="/"
                    className="text-gray-900 hover:text-gray-700 transition-all duration-300 flex items-center gap-2 group"
                  >
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3 group">
                  <FiMapPin className="mt-1 text-gray-900 group-hover:scale-110 transition-transform flex-shrink-0" />
                  <span className="text-gray-900 group-hover:text-gray-700 transition">
                    630 Anonas, Sta. Mesa, Manila, 1016 Kalakhang Maynila
                  </span>
                </li>
                <li className="flex items-center space-x-3 group">
                  <FiPhone className="text-gray-900 group-hover:scale-110 transition-transform flex-shrink-0" />
                  <span className="text-gray-900 group-hover:text-gray-700 transition">
                ...
                <li className="flex items-center space-x-3 group">
                  <FiMail className="text-gray-900 group-hover:scale-110 transition-transform flex-shrink-0" />
                  <span className="text-gray-900 group-hover:text-gray-700 transition">
              ...
              <div className="mt-8 pt-6 border-t border-white/50">
                <div className="flex items-center gap-2 mb-2">
                  <FiGlobe className="text-gray-900 w-4 h-4" />
            ...
            <div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white">
                <div className="flex items-center gap-3 mb-3">
                  <FiShield className="text-gray-900 w-5 h-5" />
                  <span className="font-semibold text-gray-900">
                    99.5% Uptime Guarantee
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <FiUsers className="text-gray-900 w-5 h-5" />
                  <span className="font-semibold text-gray-900">
          ...
          <div className="border-t border-white/50 mt-12 pt-8 text-center">
            <p className="text-gray-900 text-sm flex items-center justify-center gap-2 flex-wrap">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 w-12 h-12 bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl flex items-center justify-center text-gray-900 hover:scale-110 transition-all duration-300 z-40 hover:shadow-white/30 group border border-white"
        >
