      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
            ...
            <div>
              ...
              <ul className="space-y-3.5">
                <li>
                  <Link
                    href="/"
                    className="text-white hover:text-gray-300 transition-all duration-300 flex items-center gap-2 group"
                  >
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3 group">
                  ...
                  <span className="text-white group-hover:text-gray-300 transition">
          ...
          <div className="border-t border-white/50 mt-12 pt-8 text-center">
            <p className="text-white text-sm flex items-center justify-center gap-2 flex-wrap">
